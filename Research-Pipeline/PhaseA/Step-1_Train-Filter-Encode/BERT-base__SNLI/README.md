...
|---|--------|--------------|--------|
| 1 | `train.py` | Fine-tune BERT-base on the SNLI train split | `results/checkpoints/final/`, `results/train_metrics.json` |
| 2 | `build_filtered_dataset.py` | Keep only train rows the model got right | `Datasets/.../filtered/BERT-base/train_correct.csv` |
| 3 | `encode_hypotheses.py` | Store every kept hypothesis at every layer | `Datasets/Encoded_Datasets/BERT-base/SNLI/hypotheses.npz` |
