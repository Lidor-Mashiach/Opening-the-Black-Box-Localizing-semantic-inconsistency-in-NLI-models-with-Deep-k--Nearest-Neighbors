...
class ParaphraseGenerator:
    ...
    def generate(self, hypotheses, temperature=1.0):
        ...
        # caps the word ratio at 1.5), so bound NEW tokens to the input length
        # + margin instead of a fixed 128 - far fewer decode steps per sample.
        max_new = int(enc["input_ids"].shape[1] * 1.5) + 8
